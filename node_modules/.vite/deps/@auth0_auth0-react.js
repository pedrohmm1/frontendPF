...
var n = 1e4;
var o = "memory";
var r = { name: "auth0-spa-js", version: "2.19.2" };
var i = () => Date.now();
var a = "default";
...
var _ = (e3) => btoa(e3);
var k = [{ key: "name", type: ["string"] }, { key: "version", type: ["string", "number"] }, { key: "env", type: ["object"] }];
var S = function(e3) {
...
var E = async (e3) => {
  const t2 = v().subtle.digest({ name: "SHA-256" }, new TextEncoder().encode(e3));
  return await t2;
};
    ...
    return void 0 === n2 && (n2 = 5e3), C(this, void 0, void 0, function() {
      ...
      return j(this, function(l2) {
        switch (l2.label) {
          ...
          case 3:
            return l2.sent(), a2.setItemSync(i2, JSON.stringify({ id: this.id, iat: o2, timeoutKey: s2, timeAcquired: Date.now(), timeRefreshed: Date.now() })), [4, N(30)];
          case 4:
...
async function B(e3, t2, n2) {
  ...
  return `${o2}.${Q(await crypto.subtle.sign(function(e4) {
    switch (e4.algorithm.name) {
      ...
      case "RSA-PSS":
        return Y(e4.algorithm), { name: e4.algorithm.name, saltLength: 32 };
      case "RSASSA-PKCS1-v1_5":
        return Y(e4.algorithm), { name: e4.algorithm.name };
      case "Ed25519":
...
var q;
if (Uint8Array.prototype.toBase64) q = (e3) => (e3 instanceof ArrayBuffer && (e3 = new Uint8Array(e3)), e3.toBase64({ alphabet: "base64url", omitPadding: true }));
else {
  const e3 = 32768;
  q = (t2) => {
...
async function re(e3, t2, n2, o2, r2, i2) {
  ...
  return B({ alg: te(a2), typ: "dpop+jwt", jwk: await ie(s2) }, Object.assign(Object.assign({}, i2), { iat: Math.floor(Date.now() / 1e3), jti: crypto.randomUUID(), htm: n2, nonce: o2, htu: t2, ath: r2 ? Q(await crypto.subtle.digest("SHA-256", G(r2))) : void 0 }), a2);
}
...
function ue(e3) {
  return async function(e4) {
    ...
    return Q(await crypto.subtle.digest({ name: "SHA-256" }, G(JSON.stringify(n2))));
  }(e3.publicKey);
}
function le(e3) {
...
var pe = async function(e3, t2, o2, r2, i2, a2) {
  let s2 = arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : n;
  return i2 ? (async (e4, t3, n2, o3, r3, i3, a3, s3) => he({ type: "refresh", auth: { audience: t3, scope: n2 }, timeout: r3, fetchUrl: e4, fetchOptions: o3, useFormData: a3, useMrrt: s3 }, i3))(e3, t2, o2, r2, s2, i2, a2, arguments.length > 7 ? arguments[7] : void 0) : (async (e4, t3, n2) => {
    const o3 = await de(e4, t3, n2);
...
async function fe(t2, n2, o2, r2, i2, a2, c2, u2, l2, h2) {
  if (l2) {
  ...
  for (let e3 = 0; e3 < 3; e3++) try {
    d2 = await pe(t2, o2, r2, i2, a2, c2, n2, u2), p2 = null;
    break;
  } catch (e4) {
    p2 = e4;
  }
  if (p2) throw p2;
  const y2 = d2.json, { error: g2, error_description: v2 } = y2, b2 = e(y2, ["error", "error_description"]), { headers: _2, ok: k2 } = d2;
  let S2;
  if (l2 && (S2 = _2[ae], S2 && await l2.setNonce(S2)), !k2) {
...
async function me(t2, n2) {
  var { baseUrl: o2, timeout: i2, audience: s2, scope: c2, auth0Client: u2, useFormData: l2, useMrrt: h2, dpop: d2 } = t2, p2 = e(t2, ["baseUrl", "timeout", "audience", "scope", "auth0Client", "useFormData", "useMrrt", "dpop"]);
  const f2 = "urn:ietf:params:oauth:grant-type:token-exchange" === p2.grant_type, m2 = "refresh_token" === p2.grant_type && h2, y2 = Object.assign(Object.assign(Object.assign(Object.assign({}, p2), f2 && s2 && { audience: s2 }), f2 && c2 && { scope: c2 }), m2 && { audience: s2, scope: c2 }), w2 = l2 ? T(y2) : JSON.stringify(y2), g2 = (v2 = p2.grant_type, se.includes(v2));
  var v2;
  return await fe("".concat(o2, "/oauth/token"), i2, s2 || a, c2, { method: "POST", body: w2, headers: { "Content-Type": l2 ? "application/x-www-form-urlencoded" : "application/json", "Auth0-Client": btoa(JSON.stringify(S(u2 || r))) } }, n2, l2, h2, g2 ? d2 : void 0);
}
var ye = function() {
...
var Se = class {
  ...
  async get(e3) {
    ...
    if (!i2) {
      ...
      if (r3 && (i2 = await this.cache.get(r3), a2 = be.fromKey(r3)), !i2 && n2 && "cache-only" !== o2) return this.getEntryWithRefreshToken(e3, t3);
    }
    if (!i2) return;
...
var Ae = (e3) => {
  ...
  const t2 = ((e4) => {
    ...
    const i2 = JSON.parse(P(o3)), a2 = { __raw: e4 }, s2 = {};
    return Object.keys(i2).forEach((e5) => {
      a2[e5] = i2[e5], Pe.includes(e5) || (s2[e5] = i2[e5]);
    }), { encoded: { header: n3, payload: o3, signature: r3 }, header: JSON.parse(P(n3)), claims: a2, user: s2 };
  })(e3.id_token);
...
function je(e3, t2, n2) {
  document.cookie = Ie(e3, t2, Re({ path: "/" }, n2));
}
var We = je;
var Ke = function(e3, t2) {
  je(e3, "", Re(Re({}, t2), { expires: -1 }));
};
var Ue = { get(e3) {
  const t2 = Ce(e3);
  ...
  let o2 = {};
  "https:" === window.location.protocol && (o2 = { secure: true, sameSite: "none" }), (null == n2 ? void 0 : n2.daysUntilExpire) && (o2.expires = n2.daysUntilExpire), (null == n2 ? void 0 : n2.cookieDomain) && (o2.domain = n2.cookieDomain), We(e3, JSON.stringify(t2), o2);
}, remove(e3, t2) {
  let n2 = {};
...
var Ne = { get(e3) {
  ...
  let o2 = {};
  "https:" === window.location.protocol && (o2 = { secure: true }), (null == n2 ? void 0 : n2.daysUntilExpire) && (o2.expires = n2.daysUntilExpire), (null == n2 ? void 0 : n2.cookieDomain) && (o2.domain = n2.cookieDomain), We("".concat(De).concat(e3), JSON.stringify(t2), o2), Ue.save(e3, t2, n2);
}, remove(e3, t2) {
  let n2 = {};
...
var qe = { memory: () => new ke().enclosedCache, localstorage: () => new _e() };
var Qe = (e3) => qe[e3];
var $e = (t2) => {
...
var ot = class {
  ...
  async getOrGenerateKeyPair() {
    ...
    return e3 || (e3 = await ce(), await this.storage.setKeyPair(e3)), e3;
  }
  async generateProof(e3) {
    const t2 = await this.getOrGenerateKeyPair();
    return le(Object.assign({ keyPair: t2 }, e3));
  }
  async calculateThumbprint() {
    return ue(await this.getOrGenerateKeyPair());
  }
  async clear() {
...
var Ht;
var Jt;
if (Uint8Array.prototype.toBase64) Ht = (e3) => (e3 instanceof ArrayBuffer && (e3 = new Uint8Array(e3)), e3.toBase64({ alphabet: "base64url", omitPadding: true }));
else {
  const e3 = 32768;
  Ht = (t2) => {
    t2 instanceof ArrayBuffer && (t2 = new Uint8Array(t2));
...
function Xt(e3, t2, n2) {
  return new Vt(e3, { code: t2, cause: n2 });
}
function Ft(e3, t2) {
  if (function(e4, t3) {
...
async function Qt(e3, t2) {
  return async function(e4, t3, n2, o2) {
    ...
    return i2.set("accept", "application/json"), ((null == o2 ? void 0 : o2[Kt]) || fetch)(r2.href, { body: void 0, headers: Object.fromEntries(i2.entries()), method: "GET", redirect: "manual", signal: Bt(r2, null == o2 ? void 0 : o2.signal) });
...
function hn(e3, t2) {
  ...
  var r2;
  return Ft(n2, '"clientPrivateKey.key"'), async (e4, r3, i2, a2) => {
    var s2;
    ...
    null == t2 || null === (s2 = t2[Ut]) || void 0 === s2 || s2.call(t2, c2, u2), i2.set("client_id", r3.client_id), i2.set("client_assertion_type", "urn:ietf:params:oauth:client-assertion-type:jwt-bearer"), i2.set("client_assertion", await async function(e5, t3, n3) {
      ...
      const o3 = "".concat(Mt(zt(JSON.stringify(e5))), ".").concat(Mt(zt(JSON.stringify(t3)))), r4 = Mt(await crypto.subtle.sign(function(e6) {
...
function fn(e3, t2, n2, o2) {
  let r2;
  if ("string" != typeof e3 || !(r2 = dn(e3))) throw Xt("authorization server metadata does not contain a valid ".concat(n2 ? '"as.mtls_endpoint_aliases.'.concat(t2, '"') : '"as.'.concat(t2, '"')), void 0 === e3 ? oo : ro, { attribute: n2 ? "mtls_endpoint_aliases.".concat(t2) : t2 });
  return pn(r2, o2), r2;
}
...
async function xn(e3, t2, n2, o2, r2, i2, a2) {
  return await n2(e3, t2, r2, i2), i2.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"), ((null == a2 ? void 0 : a2[Kt]) || fetch)(o2.href, { body: r2, headers: Object.fromEntries(i2.entries()), method: "POST", redirect: "manual", signal: Bt(o2, null == a2 ? void 0 : a2.signal) });
}
async function In(e3, t2, n2, o2, r2, i2) {
  var a2;
...
async function Wn(e3, t2, n2, o2, r2, i2) {
  ...
  if (en(a2.access_token, '"response" body "access_token" property', Yn, { body: a2 }), en(a2.token_type, '"response" body "token_type" property', Yn, { body: a2 }), a2.token_type = a2.token_type.toLowerCase(), void 0 !== a2.expires_in) {
    let e4 = "number" != typeof a2.expires_in ? parseFloat(a2.expires_in) : a2.expires_in;
    $t(e4, true, '"response" body "expires_in" property', Yn, { body: a2 }), a2.expires_in = e4;
  }
  if (void 0 !== a2.refresh_token && en(a2.refresh_token, '"response" body "refresh_token" property', Yn, { body: a2 }), void 0 !== a2.scope && "string" != typeof a2.scope) throw Xt('"response" body "scope" property must be a string', Yn, { body: a2 });
  if (void 0 !== a2.id_token) {
    en(a2.id_token, '"response" body "id_token" property', Yn, { body: a2 });
    ...
    const { claims: s2, jwt: c2 } = await async function(e4, t3, n3, o3, r3) {
      ...
      const l2 = sn() + n3;
      if (void 0 !== a3.exp) {
        if ("number" != typeof a3.exp) throw Xt('unexpected JWT "exp" (expiration time) claim type', Yn, { claims: a3 });
        if (a3.exp <= l2 - o3) throw Xt('unexpected JWT "exp" (expiration time) claim value, expiration is past current timestamp', eo, { claims: a3, now: l2, tolerance: o3, claim: "exp" });
      }
      if (void 0 !== a3.iat && "number" != typeof a3.iat) throw Xt('unexpected JWT "iat" (issued at) claim type', Yn, { claims: a3 });
      if (void 0 !== a3.iss && "string" != typeof a3.iss) throw Xt('unexpected JWT "iss" (issuer) claim type', Yn, { claims: a3 });
      if (void 0 !== a3.nbf) {
        if ("number" != typeof a3.nbf) throw Xt('unexpected JWT "nbf" (not before) claim type', Yn, { claims: a3 });
        if (a3.nbf > l2 + o3) throw Xt('unexpected JWT "nbf" (not before) claim value', eo, { claims: a3, now: l2, tolerance: o3, claim: "nbf" });
      }
      if (void 0 !== a3.aud && "string" != typeof a3.aud && !Array.isArray(a3.aud)) throw Xt('unexpected JWT "aud" (audience) claim type', Yn, { claims: a3 });
    ...
    if (Array.isArray(s2.aud) && 1 !== s2.aud.length) {
      if (void 0 === s2.azp) throw Xt('ID Token "aud" (audience) claim includes additional untrusted audiences', to, { claims: s2, claim: "aud" });
      if (s2.azp !== t2.client_id) throw Xt('unexpected ID Token "azp" (authorized party) claim value', to, { expected: t2.client_id, claims: s2, claim: "azp" });
    }
    void 0 !== s2.auth_time && $t(s2.auth_time, true, 'ID Token "auth_time" (authentication time)', Yn, { claims: s2 }), Cn.set(n2, c2), On.set(a2, s2);
  }
...
function Kn(e3, t2) {
  if (Array.isArray(t2.claims.aud)) {
    if (!t2.claims.aud.includes(e3)) throw Xt('unexpected JWT "aud" (audience) claim value', to, { expected: e3, claims: t2.claims, claim: "aud" });
  } else if (t2.claims.aud !== e3) throw Xt('unexpected JWT "aud" (audience) claim value', to, { expected: e3, claims: t2.claims, claim: "aud" });
  return t2;
}
function Un(e3, t2) {
  var n2, o2;
  const r2 = null !== (n2 = null === (o2 = e3[wo]) || void 0 === o2 ? void 0 : o2.call(e3, t2)) && void 0 !== n2 ? n2 : e3.issuer;
  if (t2.claims.iss !== r2) throw Xt('unexpected JWT "iss" (issuer) claim value', to, { expected: r2, claims: t2.claims, claim: "iss" });
  return t2;
}
var Dn = /* @__PURE__ */ new WeakSet();
var Nn = Symbol();
var Ln = { aud: "audience", c_hash: "code hash", client_id: "client id", exp: "expiration time", iat: "issued at", iss: "issuer", jti: "jwt id", nonce: "nonce", s_hash: "state hash", sub: "subject", ath: "access token hash", htm: "http method", htu: "http uri", cnf: "confirmation", auth_time: "authentication time" };
function zn(e3, t2) {
  for (const n2 of e3) if (void 0 === t2.claims[n2]) throw Xt('JWT "'.concat(n2, '" (').concat(Ln[n2], ") claim missing"), Yn, { claims: t2.claims });
  return t2;
}
var Hn = Symbol();
var Jn = Symbol();
async function Mn(e3, t2, n2, o2) {
  return "string" == typeof (null == o2 ? void 0 : o2.expectedNonce) || "number" == typeof (null == o2 ? void 0 : o2.maxAge) || null != o2 && o2.requireIdToken ? async function(e4, t3, n3, o3, r2, i2, a2) {
    ...
    const c2 = await Wn(e4, t3, n3, s2, i2, a2);
    en(c2.id_token, '"response" body "id_token" property', Yn, { body: c2 });
    const u2 = jn(c2);
    if (r2 !== Jn) {
      const e5 = sn() + rn(t3), n4 = an(t3);
      if (u2.auth_time + r2 < e5 - n4) throw Xt("too much time has elapsed since the last End-User authentication", eo, { claims: u2, now: e5, tolerance: n4, claim: "auth_time" });
    }
    if (o3 === Hn) {
      if (void 0 !== u2.nonce) throw Xt('unexpected ID Token "nonce" claim value', to, { expected: void 0, claims: u2, claim: "nonce" });
    } else if (u2.nonce !== o3) throw Xt('unexpected ID Token "nonce" claim value', to, { expected: o3, claims: u2, claim: "nonce" });
    return c2;
  }(e3, t2, n2, o2.expectedNonce, o2.maxAge, o2[Dt], o2.recognizedTokenTypes) : async function(e4, t3, n3, o3, r2) {
    const i2 = await Wn(e4, t3, n3, void 0, o3, r2), a2 = jn(i2);
    if (a2) {
      if (void 0 !== t3.default_max_age) {
        $t(t3.default_max_age, true, '"client.default_max_age"');
        const e5 = sn() + rn(t3), n4 = an(t3);
        if (a2.auth_time + t3.default_max_age < e5 - n4) throw Xt("too much time has elapsed since the last End-User authentication", eo, { claims: a2, now: e5, tolerance: n4, claim: "auth_time" });
      }
      if (void 0 !== a2.nonce) throw Xt('unexpected ID Token "nonce" claim value', to, { expected: void 0, claims: a2, claim: "nonce" });
    }
    return i2;
...
async function co(e3) {
  ...
  if ("application/x-www-form-urlencoded" !== Rn(e3)) throw Ot("form_post responses are expected to use the application/x-www-form-urlencoded content-type", xt, { cause: e3 });
  return async function(e4) {
...
function uo(e3, t2, n2, o2) {
  if (void 0 === e3) if (Array.isArray(t2)) {
    if (!t2.includes(o2.alg)) throw Xt('unexpected JWT "alg" header parameter', Yn, { header: o2, expected: t2, reason: "authorization server metadata" });
  } else {
    if (void 0 === n2) throw Xt('missing client or server configuration to verify used JWT "alg" header parameter', void 0, { client: e3, issuer: t2, fallback: n2 });
    if ("string" == typeof n2 ? o2.alg !== n2 : "function" == typeof n2 ? !n2(o2.alg) : !n2.includes(o2.alg)) throw Xt('unexpected JWT "alg" header parameter', Yn, { header: o2, expected: n2, reason: "default value" });
  }
  else if ("string" == typeof e3 ? o2.alg !== e3 : !e3.includes(o2.alg)) throw Xt('unexpected JWT "alg" header parameter', Yn, { header: o2, expected: e3, reason: "client configuration" });
}
function lo(e3, t2) {
...
function fo(e3, t2, n2, o2) {
  ...
  if (lo(n2, "response")) throw Xt('"parameters" contains a JARM response, use validateJwtAuthResponse() instead of validateAuthResponse()', Yn, { parameters: n2 });
  const r2 = lo(n2, "iss"), i2 = lo(n2, "state");
  if (!r2 && e3.authorization_response_iss_parameter_supported) throw Xt('response parameter "iss" (issuer) missing', Yn, { parameters: n2 });
  if (r2 && r2 !== e3.issuer) throw Xt('unexpected "iss" (issuer) response parameter value', Yn, { expected: e3.issuer, parameters: n2 });
  switch (o2) {
    case void 0:
    case po:
      if (void 0 !== i2) throw Xt('unexpected "state" response parameter encountered', Yn, { expected: void 0, parameters: n2 });
      break;
    case ho:
      break;
    default:
      if (en(o2, '"expectedState" argument'), i2 !== o2) throw Xt(void 0 === i2 ? 'response parameter "state" missing' : 'unexpected "state" response parameter value', Yn, { expected: o2, parameters: n2 });
  }
...
async function mo(e3) {
  ...
  if (!Gt(t2)) throw Xt('"response" body must be a top level object', Yn, { body: t2 });
  return t2;
}
var yo = Symbol();
var wo = Symbol();
...
async function Go(e3, t2, n2, o2) {
  const r2 = await Fo(e3, t2, "verify");
  !function(e4, t3) {
...
function Sr(e3) {
  return async function(e4) {
    return en(e4, "codeVerifier"), Mt(await crypto.subtle.digest("SHA-256", zt(e4)));
  }(e3);
}
function Tr() {
  return nn();
...
async function Rr(e3, t2, n2, o2, r2) {
  const i2 = await async function(e4, t3) {
    var n3, o3;
    if (!(e4 instanceof URL)) throw kr('"server" must be an instance of URL', _r);
    const r3 = !e4.href.includes("/.well-known/"), i3 = null !== (n3 = null == t3 ? void 0 : t3.timeout) && void 0 !== n3 ? n3 : 30, a3 = AbortSignal.timeout(1e3 * i3), s3 = await (r3 ? Qt(e4, { algorithm: null == t3 ? void 0 : t3.algorithm, [Kt]: null == t3 ? void 0 : t3[vr], [Ct]: null == t3 || null === (o3 = t3.execute) || void 0 === o3 ? void 0 : o3.includes(Ur), signal: a3, headers: new Headers(pr) }) : ((null == t3 ? void 0 : t3[vr]) || fetch)((pn(e4, null == t3 || null === (c2 = t3.execute) || void 0 === c2 || !c2.includes(Ur)), e4.href), { headers: Object.fromEntries(new Headers(_t({ accept: "application/json" }, pr)).entries()), body: void 0, method: "GET", redirect: "manual", signal: a3 })).then((e5) => async function(e6, t4) {
      const n4 = e6;
      ...
      if (en(o4.issuer, '"response" body "issuer" property', Yn, { body: o4 }), n4 !== yo && new URL(o4.issuer).href !== n4.href) throw Xt('"response" body "issuer" property does not match the expected value', no, { expected: n4.href, body: o4, attribute: "issuer" });
      return o4;
    }(yo, e5)).catch(Ar);
    var c2;
...
async function Cr(e3, t2, n2) {
  ...
  if (r2 && !Number.isFinite(a2)) throw new Vt("invalid Retry-After header value", { cause: e3 });
...
async function Wr(e3, t2) {
  ...
  return async function(e4, t3, n3, o3, r3) {
  ...
  }(n2, o2, r2, t2, { [Kt]: i2, [Ct]: !a2, headers: new Headers(pr), signal: Mr(s2) }).then((e4) => async function(e5, t3, n3) {
    ...
    en(o3.auth_req_id, '"response" body "auth_req_id" property', Yn, { body: o3 });
    let r3 = "number" != typeof o3.expires_in ? parseFloat(o3.expires_in) : o3.expires_in;
    return $t(r3, true, '"response" body "expires_in" property', Yn, { body: o3 }), o3.expires_in = r3, void 0 !== o3.interval && $t(o3.interval, false, '"response" body "interval" property', Yn, { body: o3 }), o3;
  }(n2, o2, e4)).catch(Ar);
}
async function Kr(e3, t2, n2, o2) {
  ...
  const { as: c2, c: u2, auth: l2, fetch: h2, tlsOnly: d2, nonRepudiation: p2, timeout: f2, decrypt: m2 } = mr(e3), y2 = (r3, i3) => Kr(e3, _t(_t({}, t2), {}, { interval: r3 }), n2, _t(_t({}, o2), {}, { signal: s2, flag: i3 })), w2 = await async function(e4, t3, n3, o3, r3) {
  ...
  }(c2, u2, l2, t2.auth_req_id, { [Kt]: h2, [Ct]: !d2, additionalParameters: n2, DPoP: null == o2 ? void 0 : o2.DPoP, headers: new Headers(pr), signal: s2.aborted ? s2 : Mr(f2) }).catch(Ar);
  var g2;
...
async function Dr(e3, t2, n2, o2, r2) {
  ...
  }(s2, c2, u2, i2, a2, (null == n2 ? void 0 : n2.pkceCodeVerifier) || Nn, { additionalParameters: o2, [Kt]: l2, [Ct]: !h2, DPoP: null == r2 ? void 0 : r2.DPoP, headers: new Headers(pr), signal: Mr(m2) }).catch(Ar);
  "string" != typeof (null == n2 ? void 0 : n2.expectedNonce) && "number" != typeof (null == n2 ? void 0 : n2.maxAge) || (n2.idTokenExpected = true);
  const v2 = Mn(s2, c2, g2, { expectedNonce: null == n2 ? void 0 : n2.expectedNonce, maxAge: null == n2 ? void 0 : n2.maxAge, requireIdToken: null == n2 ? void 0 : n2.idTokenExpected, [Dt]: y2 });
  let b2;
  try {
    b2 = await v2;
  } catch (t3) {
    if (Zr(t3, r2)) return Dr(e3, void 0, n2, o2, _t(_t({}, r2), {}, { flag: Vr, authResponse: i2, redirectUri: a2 }));
    Ar(t3);
  }
  return b2.id_token && await (null == f2 ? void 0 : f2(g2)), Or(b2), b2;
}
async function Nr(e3, t2, n2, o2) {
  Jr(e3), n2 = new URLSearchParams(n2);
  ...
  }(r2, i2, a2, t2, { [Kt]: s2, [Ct]: !c2, additionalParameters: n2, DPoP: null == o2 ? void 0 : o2.DPoP, headers: new Headers(pr), signal: Mr(l2) }).catch(Ar), p2 = async function(e4, t3, n3, o3) {
    return Wn(e4, t3, n3, void 0, null == o3 ? void 0 : o3[Dt], null == o3 ? void 0 : o3.recognizedTokenTypes);
  }(r2, i2, d2, { [Dt]: h2 });
  let f2;
  try {
    ...
    if (Zr(r3, o2)) return Nr(e3, t2, n2, _t(_t({}, o2), {}, { flag: Vr }));
    Ar(r3);
  }
...
async function Lr(e3, t2, n2) {
  ...
  }(o2, r2, i2, t2, { [Kt]: a2, [Ct]: !s2, DPoP: null == n2 ? void 0 : n2.DPoP, headers: new Headers(pr), signal: Mr(c2) }).catch(Ar), l2 = async function(e4, t3, n3, o3) {
    return Wn(e4, t3, n3, void 0, null == o3 ? void 0 : o3[Dt], null == o3 ? void 0 : o3.recognizedTokenTypes);
  }(o2, r2, u2);
  let h2;
  try {
    ...
    if (Zr(o3, n2)) return Lr(e3, t2, _t(_t({}, n2), {}, { flag: Vr }));
    Ar(o3);
  }
  return Or(h2), h2;
}
...
async function Hr(e3, t2, n2) {
  Jr(e3);
  const o2 = zr(e3, t2), { as: r2, c: i2, auth: a2, fetch: s2, tlsOnly: c2, timeout: u2 } = mr(e3), l2 = await async function(e4, t3, n3, o3, r3) {
    var i3;
    cn(e4), un(t3);
  ...
  }(r2, i2, a2, o2.searchParams, { [Kt]: s2, [Ct]: !c2, DPoP: null == n2 ? void 0 : n2.DPoP, headers: new Headers(pr), signal: Mr(u2) }).catch(Ar), h2 = async function(e4, t3, n3) {
    ...
    const o3 = await mo(n3);
    en(o3.request_uri, '"response" body "request_uri" property', Yn, { body: o3 });
    let r3 = "number" != typeof o3.expires_in ? parseFloat(o3.expires_in) : o3.expires_in;
    return $t(r3, true, '"response" body "expires_in" property', Yn, { body: o3 }), o3.expires_in = r3, o3;
  }(r2, i2, l2);
  let d2;
  try {
    d2 = await h2;
  } catch (o3) {
    if (Zr(o3, n2)) return Hr(e3, t2, _t(_t({}, n2), {}, { flag: Vr }));
    Ar(o3);
  }
  return zr(e3, { request_uri: d2.request_uri });
}
function Jr(e3) {
...
async function Xr(e3, t2, n2, o2) {
  ...
  const { as: r2, c: i2, auth: a2, fetch: s2, tlsOnly: c2, timeout: u2, decrypt: l2 } = mr(e3), h2 = await async function(e4, t3, n3, o3, r3, i3) {
  ...
  }(r2, i2, a2, t2, new URLSearchParams(n2), { [Kt]: s2, [Ct]: !c2, DPoP: null == o2 ? void 0 : o2.DPoP, headers: new Headers(pr), signal: Mr(u2) }).then((e4) => {
    let n3;
    ...
    }(r2, i2, e4, { [Dt]: l2, recognizedTokenTypes: n3 });
  }).catch(Ar);
  return Or(h2), h2;
}
async function Fr(e3, t2, n2) {
  ...
  const l2 = function() {
    ...
    return r3;
  }(void 0 !== e3.protected ? bo(e3.protected) : new Uint8Array(), bo("."), "string" == typeof e3.payload ? a2 ? bo(e3.payload) : go.encode(e3.payload) : e3.payload), h2 = Zo(e3.signature, "signature", Wo), d2 = await er(t2, s2);
  if (!await Go(s2, d2, h2, l2)) throw new zo();
  let p2;
...
async function $r(e3, t2, n2) {
  ...
  const r2 = await async function(e4, t3, n3) {
    ...
    const s2 = await Fr({ payload: r3, protected: o3, signature: i3 }, t3, n3), c2 = { payload: s2.payload, protectedHeader: s2.protectedHeader };
...
var _i = class {
  ...
  async getKey(e3, t2) {
    ...
    try {
      ...
      if (n2 instanceof Do && false === this.coolingDown()) return await this.reload(), yt(vi, this).call(this, e3, t2);
      throw n2;
    }
  }
  async reload() {
...
var ua = (Ai = /* @__PURE__ */ new WeakMap(), Ri = /* @__PURE__ */ new WeakMap(), xi = /* @__PURE__ */ new WeakMap(), class {
  ...
  set(e3, t2) {
    for (yt(Ai, this).has(e3) && yt(Ai, this).delete(e3), yt(Ai, this).set(e3, { value: t2, expiresAt: Date.now() + yt(Ri, this) }); yt(Ai, this).size > yt(xi, this); ) {
...
var ga = (Ii = /* @__PURE__ */ new WeakMap(), Oi = /* @__PURE__ */ new WeakMap(), Ci = /* @__PURE__ */ new WeakMap(), ji = /* @__PURE__ */ new WeakMap(), Wi = /* @__PURE__ */ new WeakMap(), Ki = /* @__PURE__ */ new WeakMap(), Ui = /* @__PURE__ */ new WeakMap(), Di = /* @__PURE__ */ new WeakMap(), Ni = /* @__PURE__ */ new WeakMap(), Li = /* @__PURE__ */ new WeakSet(), class {
  constructor(e3) {
    ...
    gt(Ui, this, da.createDiscoveryCache(i2)), gt(Di, this, /* @__PURE__ */ new Map()), gt(Ni, this, da.createJwksCache()), this.mfa = new sa({ domain: yt(ji, this).domain, clientId: yt(ji, this).clientId, customFetch: yt(Wi, this) });
  }
  async getServerMetadata() {
    const { serverMetadata: e3 } = await pt(Li, this, _a).call(this);
    return e3;
  }
  async buildAuthorizationUrl(e3) {
    const { serverMetadata: t2 } = await pt(Li, this, _a).call(this);
    ...
    try {
      return await pt(Li, this, Ea).call(this, e3);
    } catch (e4) {
      throw new Bi(e4);
    }
  }
  async buildLinkUserUrl(e3) {
    try {
      const t2 = await pt(Li, this, Ea).call(this, { authorizationParams: _t(_t({}, e3.authorizationParams), {}, { requested_connection: e3.connection, requested_connection_scope: e3.connectionScope, scope: "openid link_account offline_access", id_token_hint: e3.idToken }) });
  ...
  async buildUnlinkUserUrl(e3) {
    try {
      const t2 = await pt(Li, this, Ea).call(this, { authorizationParams: _t(_t({}, e3.authorizationParams), {}, { requested_connection: e3.connection, scope: "openid unlink_account", id_token_hint: e3.idToken }) });
  ...
  async backchannelAuthentication(e3) {
    const { configuration: t2, serverMetadata: n2 } = await pt(Li, this, _a).call(this), o2 = ea(_t(_t({}, yt(ji, this).authorizationParams), null == e3 ? void 0 : e3.authorizationParams)), r2 = new URLSearchParams(_t(_t({ scope: pa }, o2), {}, { client_id: yt(ji, this).clientId, binding_message: e3.bindingMessage, login_hint: JSON.stringify({ format: "iss_sub", iss: n2.issuer, sub: e3.loginHint.sub }) }));
    ...
    try {
      const e4 = await Wr(t2, r2), n3 = await Kr(t2, e4);
  ...
  async backchannelAuthenticationGrant(e3) {
    let { authReqId: t2 } = e3;
    const { configuration: n2 } = await pt(Li, this, _a).call(this), o2 = new URLSearchParams({ auth_req_id: t2 });
    try {
  ...
  async getTokenForConnection(e3) {
    ...
    try {
      return await this.exchangeToken({ connection: e3.connection, subjectToken: n2, subjectTokenType: e3.accessToken ? wa : "urn:ietf:params:oauth:token-type:refresh_token", loginHint: e3.loginHint });
    } catch (e4) {
  ...
  async getTokenByCode(e3, t2) {
    const { configuration: n2 } = await pt(Li, this, _a).call(this);
    try {
      const o2 = await Dr(n2, e3, { pkceCodeVerifier: t2.codeVerifier });
  ...
  async getTokenByRefreshToken(e3) {
    const { configuration: t2 } = await pt(Li, this, _a).call(this), n2 = new URLSearchParams();
    e3.audience && n2.append("audience", e3.audience), e3.scope && n2.append("scope", e3.scope);
    try {
      const o2 = await Nr(t2, e3.refreshToken, n2);
      return ca.fromTokenEndpointResponse(o2);
    } catch (e4) {
  ...
  async getTokenByPassword(e3) {
    const { configuration: t2 } = await pt(Li, this, _a).call(this), n2 = new URLSearchParams({ username: e3.username, password: e3.password });
    ...
    if (e3.auth0ForwardedFor) {
      const n3 = await pt(Li, this, Ta).call(this);
      o2 = new Ir(t2.serverMetadata(), yt(ji, this).clientId, yt(ji, this).clientSecret, n3), o2[vr] = (t3, n4) => yt(Wi, this).call(this, t3, _t(_t({}, n4), {}, { headers: _t(_t({}, n4.headers), {}, { "auth0-forwarded-for": e3.auth0ForwardedFor }) }));
    }
    try {
      const e4 = await Xr(o2, "password", n2);
      return ca.fromTokenEndpointResponse(e4);
    } catch (e4) {
  ...
  async buildLogoutUrl(e3) {
    const { configuration: t2, serverMetadata: n2 } = await pt(Li, this, _a).call(this);
  ...
  async verifyLogoutToken(e3) {
    const { serverMetadata: t2 } = await pt(Li, this, _a).call(this), n2 = ha(yt(ji, this).discoveryCache), o2 = t2.jwks_uri;
    ...
    }(new URL(o2), { cacheMaxAge: n2.ttlMs, [ui]: yt(Wi, this), [li]: yt(Ni, this) }));
    const { payload: r2 } = await $r(e3.logoutToken, yt(Ki, this), { issuer: t2.issuer, audience: yt(ji, this).clientId, algorithms: ["RS256"], requiredClaims: ["iat"] });
...
async function ba(e3) {
  const t2 = await pt(Li, this, Ta).call(this), n2 = new Ir(e3, yt(ji, this).clientId, yt(ji, this).clientSecret, t2);
  return n2[vr] = yt(Wi, this), n2;
}
async function _a() {
  if (yt(Ii, this) && yt(Oi, this)) return { configuration: yt(Ii, this), serverMetadata: yt(Oi, this) };
  const e3 = pt(Li, this, va).call(this), t2 = yt(Ui, this).get(e3);
  if (t2) return gt(Oi, this, t2.serverMetadata), gt(Ii, this, await pt(Li, this, ba).call(this, t2.serverMetadata)), { configuration: yt(Ii, this), serverMetadata: yt(Oi, this) };
  const n2 = yt(Di, this).get(e3);
  if (n2) {
    const e4 = await n2;
    return gt(Oi, this, e4.serverMetadata), gt(Ii, this, await pt(Li, this, ba).call(this, e4.serverMetadata)), { configuration: yt(Ii, this), serverMetadata: yt(Oi, this) };
  }
  const o2 = (async () => {
    const t3 = await pt(Li, this, Ta).call(this), n3 = await Rr(new URL("https://".concat(yt(ji, this).domain)), yt(ji, this).clientId, { use_mtls_endpoint_aliases: yt(ji, this).useMtls }, t3, { [vr]: yt(Wi, this) }), o3 = n3.serverMetadata();
  ...
  return { configuration: yt(Ii, this), serverMetadata: yt(Oi, this) };
}
async function ka(e3) {
  var t2, n2;
  const { configuration: o2 } = await pt(Li, this, _a).call(this);
  ...
  ma(e3.subjectToken);
  const r2 = new URLSearchParams({ connection: e3.connection, subject_token: e3.subjectToken, subject_token_type: null !== (t2 = e3.subjectTokenType) && void 0 !== t2 ? t2 : wa, requested_token_type: null !== (n2 = e3.requestedTokenType) && void 0 !== n2 ? n2 : "http://auth0.com/oauth/token-type/federated-connection-access-token" });
...
async function Ea(e3) {
  const { configuration: t2 } = await pt(Li, this, _a).call(this), n2 = Tr(), o2 = await Sr(n2), r2 = ea(_t(_t({}, yt(ji, this).authorizationParams), null == e3 ? void 0 : e3.authorizationParams)), i2 = new URLSearchParams(_t(_t({ scope: pa }, r2), {}, { client_id: yt(ji, this).clientId, code_challenge: o2, code_challenge_method: "S256" }));
  return { authorizationUrl: null != e3 && e3.pushedAuthorizationRequests ? await Hr(t2, i2) : await zr(t2, i2), codeVerifier: n2 };
}
...
var Wa = class {
  constructor(e3) {
    ...
    this.scope = function(e4, t3) {
      ...
      if ("object" != typeof e4) return { [a]: ye(t3, e4, ...o2) };
      let i2 = { [a]: ye(t3, ...o2) };
    ...
    const l2 = "".concat(this.domainUrl, "/me/"), h2 = this.createFetcher(Object.assign(Object.assign({}, this.options.useDpop && { dpopNonceId: "__auth0_my_account_api__" }), { getAccessToken: () => this.getTokenSilently({ authorizationParams: { scope: "create:me:connected_accounts", audience: l2 }, detailedResponse: true }) }));
    this.myAccountApi = new at(h2, l2), this.authJsClient = new ga({ domain: this.options.domain, clientId: this.options.clientId }), this.mfa = new ja(this.authJsClient.mfa, this), "undefined" != typeof window && window.Worker && this.options.useRefreshTokens && t2 === o && (this.options.workerUrl ? this.worker = new Worker(this.options.workerUrl) : this.worker = new Fe(), this.worker.postMessage({ type: "init", allowedBaseUrl: this.domainUrl }));
  }
  getConfiguration() {
  ...
  async _prepareAuthorizeUrl(e3, t2, n2) {
    var o2;
    const r2 = _(b()), i2 = _(b()), s2 = b(), c2 = await E(s2), u2 = A(c2), l2 = await (null === (o2 = this.dpop) || void 0 === o2 ? void 0 : o2.calculateThumbprint()), h2 = ((e4, t3, n3, o3, r3, i3, a2, s3, c3) => Object.assign(Object.assign(Object.assign({ client_id: e4.clientId }, e4.authorizationParams), n3), { scope: we(t3, n3.scope, n3.audience), response_type: "code", response_mode: s3 || "query", state: o3, nonce: r3, redirect_uri: a2 || e4.authorizationParams.redirect_uri, code_challenge: i3, code_challenge_method: "S256", dpop_jkt: c3 }))(this.options, this.scope, e3, r2, i2, u2, e3.redirect_uri || this.options.authorizationParams.redirect_uri || n2, null == t2 ? void 0 : t2.response_mode, l2), d2 = this._authorizeUrl(h2);
    return { nonce: i2, code_verifier: s2, scope: h2.scope, audience: h2.audience || a, redirect_uri: h2.redirect_uri, state: r2, url: d2 };
  }
  ...
  async loginWithRedirect() {
    ...
    this.transactionManager.create(Object.assign(Object.assign(Object.assign({}, h2), { appState: i2, response_type: ze.Code }), s2 && { organization: s2 }));
  ...
  async _handleLoginRedirectCallback(e3, t2) {
    ...
    return await this._requestToken(Object.assign({ audience: t2.audience, scope: t2.scope, code_verifier: t2.code_verifier, grant_type: "authorization_code", code: n2 }, l2 ? { redirect_uri: l2 } : {}), { nonceIn: u2, organization: a2 }), { appState: t2.appState, response_type: ze.Code };
  }
  async _handleConnectAccountRedirectCallback(e3, t2) {
    ...
    return Object.assign(Object.assign({}, a2), { appState: t2.appState, response_type: ze.ConnectCode });
  }
  ...
  async _getTokenSilently(t2) {
    ...
    if ("off" !== n2) {
      const e3 = await this._getEntryFromCache({ scope: o2.authorizationParams.scope, audience: o2.authorizationParams.audience || a, clientId: this.options.clientId, cacheMode: n2 });
      if (e3) return e3;
    }
    ...
    try {
      return await this.lockManager.runWithLock(r2, 5e3, async () => {
        if ("off" !== n2) {
          const e4 = await this._getEntryFromCache({ scope: o2.authorizationParams.scope, audience: o2.authorizationParams.audience || a, clientId: this.options.clientId });
          if (e4) return e4;
        }
        const e3 = this.options.useRefreshTokens ? await this._getTokenUsingRefreshToken(o2) : await this._getTokenFromIFrame(o2), { id_token: t3, token_type: r3, access_token: i3, oauthTokenScope: s3, expires_in: c2 } = e3;
        return Object.assign(Object.assign({ id_token: t3, token_type: r3, access_token: i3 }, s3 ? { scope: s3 } : null), { expires_in: c2 });
      });
    } catch (e3) {
  ...
  async _handleInteractiveErrorWithPopup(e3) {
    try {
      ...
      const t2 = await this._getEntryFromCache({ scope: e3.authorizationParams.scope, audience: e3.authorizationParams.audience || a, clientId: this.options.clientId });
  ...
  async getTokenWithPopup() {
    ...
    return (await this.cacheManager.get(new be({ scope: i2.authorizationParams.scope, audience: i2.authorizationParams.audience || a, clientId: this.options.clientId }), void 0, this.options.useMrrt)).access_token;
  }
  ...
  _buildLogoutUrl(t2) {
    ...
    return this._url("/v2/logout?".concat(T(Object.assign({ clientId: t2.clientId }, r2)))) + i2;
  }
  async revokeRefreshToken() {
    let e3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    if (!this.options.useRefreshTokens) return;
    const t2 = e3.audience || this.options.authorizationParams.audience || a, o2 = await this.cacheManager.getRefreshTokensByAudience(t2, this.options.clientId);
    await async function(e4, t3) {
      let { baseUrl: o3, timeout: i2, auth0Client: c2, useFormData: u2, refreshTokens: l2, audience: h2, client_id: d2, onRefreshTokenRevoked: p2 } = e4;
      const f2 = i2 || n, m2 = "refresh_token", y2 = "".concat(o3, "/oauth/revoke"), w2 = { "Content-Type": u2 ? "application/x-www-form-urlencoded" : "application/json", "Auth0-Client": btoa(JSON.stringify(S(c2 || r))) };
      if (t3) {
        const e5 = { client_id: d2, token_type_hint: m2 }, n2 = u2 ? T(e5) : JSON.stringify(e5);
        try {
          return await he({ type: "revoke", timeout: f2, fetchUrl: y2, fetchOptions: { method: "POST", body: n2, headers: w2 }, useFormData: u2, auth: { audience: null != h2 ? h2 : a } }, t3);
        } catch (e6) {
          throw new s("revoke_error", e6.message);
        }
      }
      for (const e5 of l2) {
        const t4 = { client_id: d2, token_type_hint: m2, token: e5 }, n2 = u2 ? T(t4) : JSON.stringify(t4), o4 = await de(y2, { method: "POST", body: n2, headers: w2 }, f2);
        if (!o4.ok) {
          let e6, t5;
          try {
            ({ error: e6, error_description: t5 } = JSON.parse(await o4.text()));
          } catch (e7) {
          }
          throw new s(e6 || "revoke_error", t5 || "HTTP error ".concat(o4.status));
        }
        await (null == p2 ? void 0 : p2(e5));
      }
    }({ baseUrl: this.domainUrl, timeout: this.httpTimeoutMs, auth0Client: this.options.auth0Client, useFormData: this.options.useFormData, client_id: this.options.clientId, refreshTokens: o2, audience: t2, onRefreshTokenRevoked: (e4) => this.cacheManager.stripRefreshToken(e4) }, this.worker);
  }
  async logout() {
    let t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    var n2;
    const o2 = $e(t2), { openUrl: r2 } = o2, i2 = e(o2, ["openUrl"]);
    if (null === t2.clientId ? await this.cacheManager.clear() : await this.cacheManager.clear(t2.clientId || this.options.clientId), this.cookieStorage.remove(this.orgHintCookieName, { cookieDomain: this.options.cookieDomain }), this.cookieStorage.remove(this.isAuthenticatedCookieName, { cookieDomain: this.options.cookieDomain }), this.userCache.remove(ve), await (null === (n2 = this.dpop) || void 0 === n2 ? void 0 : n2.clear()), this.worker) try {
      await he({ type: "clear" }, this.worker);
    } catch (e3) {
    }
  ...
  async _getTokenFromIFrame(e3) {
    ...
    try {
      return await this.lockManager.runWithLock(t2, 5e3, async () => {
        ...
        const { url: o2, state: r2, nonce: i2, code_verifier: a2, redirect_uri: c2, scope: u2, audience: h2 } = await this._prepareAuthorizeUrl(t3, { response_mode: "web_message" }, window.location.origin);
        ...
        const m2 = await this._requestToken(Object.assign(Object.assign({}, e3.authorizationParams), { code_verifier: a2, code: f2.code, grant_type: "authorization_code", redirect_uri: c2, timeout: e3.authorizationParams.timeout || this.httpTimeoutMs }), { nonceIn: i2, organization: t3.organization });
        return Object.assign(Object.assign({}, m2), { scope: u2, oauthTokenScope: m2.scope, audience: h2 });
      });
    } catch (e4) {
      if ("login_required" === e4.error) {
        e4 instanceof s && this._isIframeMfaError(e4) && "popup" === this.options.interactiveErrorHandler || this.logout({ openUrl: false });
      }
      throw e4;
    }
  }
  async _getTokenUsingRefreshToken(e3) {
    var t2, n2;
    const o2 = await this.cacheManager.get(new be({ scope: e3.authorizationParams.scope, audience: e3.authorizationParams.audience || a, clientId: this.options.clientId }), void 0, this.options.useMrrt);
    ...
    try {
      const t3 = await this._requestToken(Object.assign(Object.assign(Object.assign({}, e3.authorizationParams), { grant_type: "refresh_token", refresh_token: o2 && o2.refresh_token, redirect_uri: r2 }), i2 && { timeout: i2 }), { scopesToRequest: s2 });
      ...
      return Object.assign(Object.assign({}, t3), { scope: e3.authorizationParams.scope, oauthTokenScope: t3.scope, audience: e3.authorizationParams.audience || a });
    } catch (o3) {
      if (o3.message) {
  ...
  async _getIdTokenFromCache() {
    const e3 = this.options.authorizationParams.audience || a, t2 = this.scope[e3], n2 = await this.cacheManager.getIdToken(new be({ clientId: this.options.clientId, audience: e3, scope: t2 })), o2 = this.userCache.get(ve);
  ...
  async _requestToken(e3, t2) {
    var n2, o2;
    const { nonceIn: r2, organization: i2, scopesToRequest: s2 } = t2 || {}, c2 = await me(Object.assign(Object.assign({ baseUrl: this.domainUrl, client_id: this.options.clientId, auth0Client: this.options.auth0Client, useFormData: this.options.useFormData, timeout: this.httpTimeoutMs, useMrrt: this.options.useMrrt, dpop: this.dpop }, e3), { scope: s2 || e3.scope }), this.worker), u2 = await this._verifyIdToken(c2.id_token, r2, i2);
  ...
  async connectAccountWithRedirect(e3) {
    ...
    const s2 = _(b()), c2 = b(), u2 = await E(c2), l2 = A(u2), { connect_uri: h2, connect_params: d2, auth_session: p2 } = await this.myAccountApi.connectAccount({ connection: o2, scopes: r2, redirect_uri: a2, state: s2, code_challenge: l2, code_challenge_method: "S256", authorization_params: i2 });
    this.transactionManager.create({ state: s2, code_verifier: c2, auth_session: p2, redirect_uri: a2, appState: n2, connection: o2, response_type: ze.ConnectCode });
    const f2 = new URL(h2);
...
var Auth0Provider = function(opts) {
  ...
  var client = (0, import_react.useState)(function() {
    return providedClient !== null && providedClient !== void 0 ? providedClient : new Wa(toAuth0ClientOptions(clientOpts));
  })[0];
